...
img = cv2.imread("pika.png") #"reading an image" loading into the secondary memory
...
cv2.waitKey(0) 
cv2.destroyAllWindows() #Removes all unnescesary temporary windows to save memory.